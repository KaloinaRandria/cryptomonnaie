...
public class InscriptionService {
    ...
    public String confirmerPin(int idUtilisateur, String pin) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            if ("success".equals(jsonResponse.getString("status"))) {
                return "PIN validé, vous êtes connecté avec succès.";
            } else {
                return "Erreur lors de la validation du PIN : " + jsonResponse.getJSONObject("error").getString("message");
            }
        } else {
            // Si l'API Symfony a renvoyé une erreur
            return "Erreur lors de l'appel à l'API Symfony : " + response.getBody();
        }
    }
